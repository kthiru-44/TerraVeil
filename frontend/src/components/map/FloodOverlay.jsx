...
export default function FloodOverlay({ geojson, viewMode, scanId }) {
    const style = useMemo(() => {
        return (feature) => {
            ...
            const colors = isDrought ? DROUGHT_COLORS : FLOOD_COLORS;
            ...
            return {
                fillColor,
                fillOpacity: 0.7,
                color: isDrought ? 'rgba(245, 158, 11, 0.6)' : 'rgba(0, 212, 255, 0.6)',
                weight: 1.5,
                dashArray: isDrought ? '5 5' : null,
            };
        };
    }, [viewMode]);
    ...
    return (
        <GeoJSON
            ...
            <strong style="color:#00d4ff;">${type.toUpperCase()} ZONE</strong><br/>
